    ...
    if (path.startsWith("/api/export.csv")) {
      ...
      const samples = rows.results.map((r) => {
        ...
        return {
          ...
          ts_local: fmt(r.ts),
          ...si,
          // SI first for convenience
          ...raw,
          // raw fields also included
...
__name(fmt, "fmt");
var num = /* @__PURE__ */ __name((v) => v == null || v === "" ? null : Number(v), "num");
...
function toSI(d) {
  ...
  const rate2mm = /* @__PURE__ */ __name((x) => x == null ? null : Number(x) * 25.4, "rate2mm");
